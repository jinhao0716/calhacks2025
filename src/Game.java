...
public class Game
{
     ...
     * @return true if they reached goal, false if didnt
     */
    public static boolean play(int[][] board, int player)
    {
        ...
        curPos = findPlayer(board, player);

        //check to see if this move placed them onto their goal island
        if(goalReached(board, curPos, player))
        {
            return true;
        }

        //otherwise return false if didnt reach goal
        return false;
    }
